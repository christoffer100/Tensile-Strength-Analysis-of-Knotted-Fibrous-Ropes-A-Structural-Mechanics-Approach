...
function write_VTK(write_counter, step, t, conf, energy, vtkdata, control) 
    ...
    recompute_at_gausspts!(vtkdata, nodes, beams, sdf, contact, control)
...
function recompute_at_gausspts!(vtkdata, nodes, beams, sdf, contact, control)
    ...
    total_energy_beam = zeros(Float64, nb)
